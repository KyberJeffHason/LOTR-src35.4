    ...
    public void updateEntity() {
        ...
        if(!this.worldObj.isRemote) {
            if(this.targetResetTick > 0) {
                ...
                this.targetX = MathHelper.getRandomIntegerInRange(this.worldObj.rand, -1000000, 1000000);
                this.targetZ = MathHelper.getRandomIntegerInRange(this.worldObj.rand, -1000000, 1000000);
