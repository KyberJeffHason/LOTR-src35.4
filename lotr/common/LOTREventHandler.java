...
public class LOTREventHandler implements IFuelHandler {
    ...
    public void onLivingDeath(LivingDeathEvent event) {
        ...
        if(!world.isRemote && LOTRMod.getNPCFaction(entity) == LOTRFaction.UTUMNO && LOTRDimension.getCurrentDimension(world) == LOTRDimension.UTUMNO && (attacker = source.getEntity()) instanceof EntityPlayer) {
            i = MathHelper.floor_double(entity.posX);
            j = MathHelper.floor_double(entity.boundingBox.minY);
